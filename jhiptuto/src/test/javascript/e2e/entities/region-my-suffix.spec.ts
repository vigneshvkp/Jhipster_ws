...
describe('Region e2e test', () => {
    ...
    it('should load Regions', () => {
        ...
        expect(regionComponentsPage.getTitle()).toMatch(/tuto2App.region.home.title/);
    ...
    it('should load create Region dialog', () => {
        ...
        expect(regionDialogPage.getModalTitle()).toMatch(/tuto2App.region.home.createOrEditLabel/);
