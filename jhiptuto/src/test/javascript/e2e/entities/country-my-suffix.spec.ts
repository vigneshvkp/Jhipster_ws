...
describe('Country e2e test', () => {
    ...
    it('should load Countries', () => {
        ...
        expect(countryComponentsPage.getTitle()).toMatch(/tuto2App.country.home.title/);
    ...
    it('should load create Country dialog', () => {
        ...
        expect(countryDialogPage.getModalTitle()).toMatch(/tuto2App.country.home.createOrEditLabel/);
