...
describe('Department e2e test', () => {
    ...
    it('should load Departments', () => {
        ...
        expect(departmentComponentsPage.getTitle()).toMatch(/tuto2App.department.home.title/);
    ...
    it('should load create Department dialog', () => {
        ...
        expect(departmentDialogPage.getModalTitle()).toMatch(/tuto2App.department.home.createOrEditLabel/);
