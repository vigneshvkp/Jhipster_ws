...
describe('JobHistory e2e test', () => {
    ...
    it('should load JobHistories', () => {
        ...
        expect(jobHistoryComponentsPage.getTitle()).toMatch(/tuto2App.jobHistory.home.title/);
    ...
    it('should load create JobHistory dialog', () => {
        ...
        expect(jobHistoryDialogPage.getModalTitle()).toMatch(/tuto2App.jobHistory.home.createOrEditLabel/);
