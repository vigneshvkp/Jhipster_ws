...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', () => {
        ...
        expect(employeeComponentsPage.getTitle()).toMatch(/tuto2App.employee.home.title/);
    ...
    it('should load create Employee dialog', () => {
        ...
        expect(employeeDialogPage.getModalTitle()).toMatch(/tuto2App.employee.home.createOrEditLabel/);
