...
describe('Location e2e test', () => {
    ...
    it('should load Locations', () => {
        ...
        expect(locationComponentsPage.getTitle()).toMatch(/tuto2App.location.home.title/);
    ...
    it('should load create Location dialog', () => {
        ...
        expect(locationDialogPage.getModalTitle()).toMatch(/tuto2App.location.home.createOrEditLabel/);
